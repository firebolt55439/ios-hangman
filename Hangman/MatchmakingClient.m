...
{
    NSMutableArray *_availableServers; // servers that we have discovered (and care about)
    ClientState _clientState; // current client state
    NSString *_serverPeerID; // peer ID of server we are connected to
}
...
{
    [self startSearchingForServersWithSessionID:@"Hangman"];
}
